...
public class RWODPublicKeySerParameter extends PairingKeySerParameter{
    ...
    public RWODPublicKeySerParameter(
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof RWODPublicKeySerParameter) {
            RWODPublicKeySerParameter that = (RWODPublicKeySerParameter)anObject;
            //Compare g
