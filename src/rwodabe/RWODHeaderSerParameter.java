...
public class RWODHeaderSerParameter extends PairingCipherSerParameter {
	/**
	 * 
	 */
    ...
    public RWODHeaderSerParameter(PairingParameters pairingParameters, Element C0,
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof RWODHeaderSerParameter) {
           RWODHeaderSerParameter that = (RWODHeaderSerParameter)anObject;
            //Compare C0
