...
public class RWODMasterSecretKeySerParameter extends PairingKeySerParameter{

	private static final long serialVersionUID = 1L;
	private transient Element alpha;
    private final byte[] byteArrayAlpha;

    public RWODMasterSecretKeySerParameter (PairingParameters pairingParameters, Element alpha) {
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof RWODMasterSecretKeySerParameter) {
            RWODMasterSecretKeySerParameter that = (RWODMasterSecretKeySerParameter)anObject;
            //compare alpha
