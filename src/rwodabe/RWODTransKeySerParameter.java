...
public class RWODTransKeySerParameter extends PairingKeySerParameter{
	...
	private transient Element K0;
	    ...
	    public RWODTransKeySerParameter(PairingParameters pairingParameters, Element K0, Element K1,
	    ...
	    public boolean equals(Object anObject) {
	        ...
	        if (anObject instanceof RWODTransKeySerParameter) {
	            RWODTransKeySerParameter that = (RWODTransKeySerParameter)anObject;
	            //Compare K0
