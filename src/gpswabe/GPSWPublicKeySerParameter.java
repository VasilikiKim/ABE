...
public class GPSWPublicKeySerParameter  extends PairingKeySerParameter {
    ...
    public GPSWPublicKeySerParameter(PairingParameters parameters, Element g, Map<String, Element> Ts, Element Y) {
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof GPSWPublicKeySerParameter) {
            GPSWPublicKeySerParameter that = (GPSWPublicKeySerParameter)anObject;
