...
public class RWCiphertextSerParameter extends RWHeaderSerParameter{
	/**
	 * 
	 */
    ...
    public RWCiphertextSerParameter(PairingParameters pairingParameters, Element C, Element C0,
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof RWCiphertextSerParameter) {
            RWCiphertextSerParameter that = (RWCiphertextSerParameter) anObject;
