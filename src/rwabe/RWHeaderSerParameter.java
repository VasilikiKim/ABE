...
public class RWHeaderSerParameter extends PairingCipherSerParameter {
	/**
	 * 
	 */
    ...
    public RWHeaderSerParameter(PairingParameters pairingParameters, Element C0,
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof RWHeaderSerParameter) {
           RWHeaderSerParameter that = (RWHeaderSerParameter)anObject;
            //Compare C0
