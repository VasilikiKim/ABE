...
public class RWKeyPairGenerator implements PairingKeyPairGenerator2{
    ...
    public PairingKeySerPair generateKeyPair() {
        ...
        return new PairingKeySerPair(
                new RWPublicKeySerParameter(this.parameters.getPairingParameters(), g, u, h, w, v, eggAlpha),
                new RWMasterSecretKeySerParameter(this.parameters.getPairingParameters(), alpha));
    }
}
