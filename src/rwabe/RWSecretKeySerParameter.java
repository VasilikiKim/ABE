...
public class RWSecretKeySerParameter extends PairingKeySerParameter{
	 /**
	 * 
	 */
	...
	private transient Element K0;
	    ...
	    public RWSecretKeySerParameter(PairingParameters pairingParameters, Element K0, Element K1,
	    ...
	    public boolean equals(Object anObject) {
	        ...
	        if (anObject instanceof RWSecretKeySerParameter) {
	            RWSecretKeySerParameter that = (RWSecretKeySerParameter)anObject;
	            //Compare K0
