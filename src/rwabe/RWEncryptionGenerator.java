...
public final class RWEncryptionGenerator implements PairingEncryptionGenerator, PairingEncapsulationPairGenerator {
	private RWPublicKeySerParameter publicKeyParameter;
    ...
    public void init(CipherParameters parameter) {
        ...
        this.publicKeyParameter = (RWPublicKeySerParameter) this.parameter.getPublicKeyParameter();
    }
    ...
    public PairingCipherSerParameter generateCiphertext() {
        ...
        return new RWCiphertextSerParameter(publicKeyParameter.getParameters(), C, C0, C1s, C2s, C3s);
    }
    ...
    public PairingKeyEncapsulationSerPair generateEncryptionPair() {
        ...
        return new PairingKeyEncapsulationSerPair(
                ...
                new RWHeaderSerParameter(publicKeyParameter.getParameters(), C0, C1s, C2s, C3s)
        );
    }
}
